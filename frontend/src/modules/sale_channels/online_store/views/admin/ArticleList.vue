        ...
        <div class="padding-container">
          <div class="row no-gutters pb-4 page-header">
            <div class="col align-items-center d-flex">
              <p class="title-page">{{ $t('post_list') }}</p>
            </div>
            <div class="col-auto pl-0 d-flex gap-10">
              <Button class="ms-btn btn-mono--secondary ms-btn-size-m mr-5 action">
                <div class="svg-next-icon-size-18">
                  <div class="icon-blog"></div>
                </div>
                <div class="p-button-label ml-3">{{ $t('blog_management') }}</div>
              </Button>
              <Button class="ms-btn btn-mono--secondary ms-btn-size-m mr-5 action">
                <div class="svg-next-icon-size-18">
                  <div class="icon-comment"></div>
                </div>
                <div class="p-button-label ml-3">{{ $t('comment_management') }}</div>
              </Button>
              <Button class="ms-btn btn-accent--primary ms-btn-size-m">
                <div class="svg-next-icon-size-16">
                  <div class="icon-add-circle"></div>
                </div>
                <div class="p-button-label ml-3">{{ $t('create_post') }}</div>
              </Button>
            </div>
          </div>
          <div>
            <div class="omni-tabs-wrapper ">
              ...
              <div class="position-relative">
                <div class="pt-0 px-4 pb-15 pl-15 pr-15" v-html="$t('post_count_message', {count: 1})">
                </div>
