<template>
  <header class="ms-header">
    <div class="ms-main-header">
      <div class="ms-container-fluid justify-content-between d-flex">
        ...
        <div class="ms-header-middle d-flex justify-content-between flex-1 flex-column">
                ...
                <div class="ms-header-search_btn">
                  <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Regular/MagnifyingGlass">
                      ...
                      <path id="Vector_2" d="M14.2031 13.7031L18 17.5" stroke="#fff" stroke-width="1.5"
          ...
          <div class="ms-header-policy-search mt-10 d-none d-xl-block">
            <div class="d-flex gap-3">
              <div class="policy-search-item">
                <div class="icon">
                  <img src="/assets/images/header_03_policy_1_ico.png" alt="">
                </div>
                <div>
                  {{ $t('delivery') }}
                </div>
              ...
              <div class="policy-search-item">
                <div class="icon">
                  <img src="/assets/images/header_03_policy_2_ico.png" alt="">
                </div>
                <div>
                  {{ $t('store_system') }}
                </div>
              ...
              <div class="policy-search-item">
                <div class="icon">
                  <img src="/assets/images/header_03_policy_3_ico.png" alt="">
                </div>
                <div>
                  {{ $t('hotline') }}
                </div>
    ...
    <div class="ms-header-desktop">
      <div class="ms-container-fluid d-none d-lg-block">
        <Menubar :model="items"/>
      </div>
    </div>
        ...
        <InputIcon>
          <div class="ms-header-search_btn">
            <svg version="1.1" class="svg search" xmlns="http://www.w3.org/2000/svg"
                 ...
                 style="enable-background:new 0 0 24 27;" xml:space="preserve"><path d="M10,2C4.5,2,0,6.5,0,12s4.5,10,10,10s10-4.5,10-10S15.5,2,10,2z M10,19c-3.9,0-7-3.1-7-7s3.1-7,7-7s7,3.1,7,7S13.9,19,10,19z"></path>
